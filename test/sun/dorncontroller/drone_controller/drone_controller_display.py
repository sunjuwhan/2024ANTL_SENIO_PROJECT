...
class class_drone_controller_display:
    ...
    def setup_threads(self):
        # Create threads for updating GPS, Switches, and Joystick
        self.gps_thread = threading.Thread(target=self.update_gps)
        self.switch_thread = threading.Thread(target=self.update_switches)
