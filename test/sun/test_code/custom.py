...
manual_inputs = [
    [1, 0, 0.5, 0],  # no movement
    [1, 0, 0.5, 0],  # minimum roll
    [1, 0, 0.5, 0],  # maximum roll
    [1, 0, 0.5, 0],  # minimum pitch
    [1, 0, 0.5, 0],  # maximum pitch
    [1, 0, 0.5, 0],  # minimum yaw
    [1, 0, 0.5, 0],  # maximum yaw
    [1, 0, 0.5, 0],  # max throttle
    [1, 0, 0, 0],  # minimum throttle
]
